...
client.on("guildMemberAdd", async member => {
  ...
  if (chx === null) {
   ...
   let data = await canva.welcome(member, { link: "https://static.wikia.nocookie.net/ultimas-cosmology/images/e/e5/Maxresdefault.jpg/revision/latest?cb=20200611075552" })
...
client.on("ready", () => {
    client.user.setActivity(`/help | Quixkz On YT`, { type: "PLAYING"})
})
